      ...
      <div className='container'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
           ...
           <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow  to-brandYellow/90 text-white rounded-3xl relative
            ...
            <img src= {Image2} className='w-[150px] absolute rounded-full   -right-1 lg:top-[40px] ' />
           </div>
           {/*  first col */}
           <div className=' sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative
            ...
            <img src= {Image3} className='w-[200px] absolute rounded-full   top-1/2  -translate-y-1/2 -right-0' />
           </div>
        </div>
      </div>
    </div>
