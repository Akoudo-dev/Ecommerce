...
const Hero = ({handleOrderPopup}) => {
  ...
  return (
   <div className='container'>
     <div className="overflow-hidden rounded-3xl min-h-[500px] sm:h-[550px] sm:min-h-[650px] hero-bg-color 
          ...
          <div key={index}>
            <div className="grid grid-cols-1 sm:grid-cols-2">
              ...
              <div className='order-1 sm:order-2'>
                ...
                >
                  <img src={data.id} alt="hero" className='w-[300px] h-[300px] sm:w-[450px] sm:scale-105 lg:scale-120 object-contain sm:h-[450px] mx-auto drop-shadow-[-8px_4px_6px_rgba(0,0,0,.4)] relative z-40' />
                </div>
              </div>
            </div>
          </div>
