...
const Banner = ({ data }) => {
  return (
    <div className='min-h-[550px] flex justify-center items-center py-12 px-20 rounded-2xl'>
      <div style={ {backgroundColor: data.bgColor} } className='container  '>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center
           ...
           <div className='p-6 sm:p-8'>
            ...
            <h1 data-aos='zoom-out' className='upercase text-4xl lg:text-7xl font-bold'>
                    { "" }
                {data.title} 
                </h1>
           ...
           {/*  second col */}
           <div data-aos='zoom-in' className='h-full items-center flex'>
            <img src= {data.image} className='scale-125 w-[150px] md:w-[200px] mx-auto drop-shadow-2xl object-cover' />
           </div>
           {/*  third col */}
